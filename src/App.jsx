...
import { CreateOrderTMDT, CreateOrderRetail, CreateOrderWholesale, ManageOrdersTMDT } from './pages/Orders';
          ...
          <Routes>
            ...
            <Route path="/" element={
              ...
              <Route path="orders/manage">
                ...
                <Route path="retail" element={<div>Manage Retail Orders (Coming Soon)</div>} />
